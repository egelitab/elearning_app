                ...
                _buildMenuIcon(
                  ...
                  () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => const InstructorFilesScreen(
                          showToggle: false,
                ...
                _buildMenuIcon(
                  ...
                  () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => const InstructorQuizScreen(),
                      ),
                    );
                  },
                ),
            ...
            _buildListAction(
              ...
              () {
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(content: Text("BDU ELMS v1.0.0")),
                );
              },
            ),
          ],
