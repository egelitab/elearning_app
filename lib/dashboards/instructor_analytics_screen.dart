              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 4),
                    const Text(
                      "Tap a course for detailed breakdown",
              ...
              child: Column(
                ...
                children: [
                  ...
                  _card([
                    _row(
                      "Enrolled Students",
                      "${_data!['enrolled_students'] ?? 0}",
                      Colors.blue,
                    ),
                    _row(
                      "Assignments Created",
                      "${_data!['assignment_count'] ?? 0}",
                      Colors.orange,
                    ),
                    _row(
                      "Submissions Received",
                      "${_data!['submission_count'] ?? 0}",
                      Colors.green,
                    ),
                    _row(
                      "Average Grade",
                      "${_data!['average_grade'] ?? 0}%",
                      Colors.purple,
                    ),
                  ]),
                  SizedBox(height: 20),
                  ...
                  _card([
                    _row(
                      "Sessions Held",
                      "${_data!['session_count'] ?? 0}",
                      Colors.blue,
                    ),
                    _row(
                      "Present Marks",
                      "${_data!['attendance_present'] ?? 0}",
                      Colors.green,
                    ),
                    _row(
                      "Late Marks",
                      "${_data!['attendance_late'] ?? 0}",
                      Colors.orange,
                    ),
                    _row(
                      "Absent Marks",
                      "${_data!['attendance_absent'] ?? 0}",
                      Colors.red,
                    ),
                  ]),
                  SizedBox(height: 20),
                  ...
                  // Top Students
                  if ((_data!['top_students'] as List?)?.isNotEmpty ==
                      true) ...[
                  ...
                  SizedBox(height: 8),
                  _progressBar(
                    double.tryParse(_data!['average_grade'].toString()) ?? 0,
                  ),
                ],
              ),
            ),
