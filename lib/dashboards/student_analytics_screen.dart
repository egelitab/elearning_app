                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _detailCard([
                      _detailRow(
                        "Completed",
                        "${_data!['assignments_completed'] ?? 0}",
                        Colors.green,
                      ),
                      _detailRow(
                        "Pending",
                        "${_data!['assignments_pending'] ?? 0}",
                        Colors.orange,
                      ),
                    ]),
                    SizedBox(height: 20),
                    ...
                    if ((_data!['attendance_total'] ?? 0) > 0) ...[
                      ...
                      SizedBox(height: 12),
                      _progressBar(
                        double.tryParse(_data!['attendance_rate'].toString()) ??
                            0,
                      ),
                    ],
